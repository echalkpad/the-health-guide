...
export class FitnessService {
  ...
  private setAgeLabel(userFitness: Fitness): void {
    if (userFitness.infancy) {
      userFitness.ageLabel = (userFitness.age <= 6) ? "0-6 months" : "7-12 months";
    } else {
      userFitness.ageLabel = (userFitness.age <= 3) ? "1-3 years" :
